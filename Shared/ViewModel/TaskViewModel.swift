...
class TaskViewModel: ObservableObject{
    ...
    @Published var storedTasks: [Task] = [
        ...
        Task(taskTitle: "Meeting", taskDescription: "Discuss team task for the day", taskDate: .now.addingTimeInterval(3600)),
        Task(taskTitle: "Icon set", taskDescription: "Edit icons for team task for next week", taskDate: .now.addingTimeInterval(3600 * 1)),
        Task(taskTitle: "Prototype", taskDescription: "Make and send prototype", taskDate: .now.addingTimeInterval(3600 * 2)),
        Task(taskTitle: "Check asset", taskDescription: "Start checking the assets", taskDate: .now.addingTimeInterval(3600 * 3)),
        Task(taskTitle: "Team party", taskDescription: "Make fun with team mates", taskDate: .now.addingTimeInterval(3600 * 4)),
        Task(taskTitle: "Client Meeting", taskDescription: "Explain project to clinet", taskDate: .now.addingTimeInterval(3600 * 5)),
        
        Task(taskTitle: "Next Project", taskDescription: "Discuss next project with team", taskDate: .now.addingTimeInterval(3600 * 6)),
        Task(taskTitle: "App Proposal", taskDescription: "Meet client for next App Proposal", taskDate: .now.addingTimeInterval(3600 * 7)),
    ]
